...
const AIAssistant: React.FC<AIAssistantProps> = ({ onSuggestion }) => {
  ...
  return (
    <div className="mb-8 p-6 bg-gradient-to-br from-gray-900 to-black rounded-lg border border-gray-700 shadow-lg">
      <div className="flex items-start space-x-4">
        ...
        <div>
          ...
          <p className="text-gray-400 mt-1">Describe a movie you're in the mood for, and our AI will find the best match from our catalog.</p>
        </div>
      </div>
      <div className="mt-4 flex flex-col sm:flex-row gap-2">
        <input
          ...
          placeholder="e.g., a funny space movie with robots"
          disabled={isLoading}
